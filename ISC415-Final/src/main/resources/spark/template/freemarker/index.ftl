                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    <a href="${url.shortenedUrl}">
                                        <div class="card bg-light mb-3" style="max-width: 540px; position: relative; padding: 2px;">
                                            <div class="row no-gutters">
                                                <div class="col-md-4">
                                                    <img src="${url.image_url}" class="card-img" style="padding-left: 5px; max-height: 90%; max-width: 100%; position: absolute; top: 50%; transform: translate(0, -50%)">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="card-body">
